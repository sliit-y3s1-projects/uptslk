...
public record UpdateProfileRequest(string Name, string? HomeLocation = null, string? NicNumber = null, string? Gender = null, string? ProfilePhotoUrl = null);
public record VerifyNicRequest(string NicNumber);
public record AuthResponse(string Token, string UserId, string Name, string Email, string Role, Guid? CentreId);
