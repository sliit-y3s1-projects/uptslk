...
export function PageHeading({
  ...
  function deleteCentre() {
    if (!centreId) return;
    closeCentre.mutate(centreId, {
      onSuccess: () => navigate("/admin/centres"),
    });
  }
  return (
        ...
        {centreId && (
          <AlertDialog open={deleteOpen} onOpenChange={setDeleteOpen}>
            <Button
              ...
              disabled={closeCentre.isPending}
            >
              <Trash2 /> Delete centre
            </Button>
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>Delete this centre?</AlertDialogTitle>
                <AlertDialogDescription>
                  This permanently removes the centre record. Related
                  operational data may no longer be available.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
